    ...
    resources: {
      en: {
        translation: {
          ...
          vidhan: "Venture",
          proud:
            "We are proud to have developed this website as part of the Vedaverse EduHacks1.0, showcasing our team's dedication to learning, growing, and contributing to technological advancements.",
          SIH: "Vedaverse",
          SIHbody:
            "is a nationwide initiative to provide students with a platform to create advanced Educational Platform for innovation and creativity while enhancing skills like problem-solving and collaboration. It brings together bright minds to create solutions for real-world problems in a competitive environment.",
          ahvac: "Already have an account?",
          log: "Log In",
          About: "About us",
          timeline: "Timeline",
          pc: "Education is the key to unlocking ",
          Demo: "Try a demo!",
          tip: "passport to freedom!",
          at: "the world, a",
          Signin: "Sign in",
          sup: "Sign up",
      ...
      hi: {
        translation: {
          ...
          pass: "पासवर्ड",
          passh: "कृपया अपना पासवर्ड दर्ज करें!",
          toggle: "भाषा बदलें",
          login: "लॉगिन करें",
          accna: "क्या आपका खाता नहीं है?",
          testimonial: "यहाँ कुछ विशेषज्ञों की प्रशंसाएँ हैं!",
          vidhan: "वेंचर",
          proud:
            "हमें गर्व है कि हमने वेदवर्स EduHacks1.0 के हिस्से के रूप में इस वेबसाइट का विकास किया है, जो हमारी टीम की सीखने, बढ़ने और तकनीकी प्रगति में योगदान देने की प्रतिबद्धता को प्रदर्शित करता है।",
          SIH: "वेदवर्स",
          SIHbody:
            "एक राष्ट्रव्यापी पहल है जो छात्रों को नवाचार और रचनात्मकता के लिए एक उन्नत शैक्षिक मंच बनाने का मंच प्रदान करती है, जबकि समस्या-समाधान और सहयोग जैसी कौशलों को बढ़ावा देती है। यह प्रतिस्पर्धी माहौल में वास्तविक दुनिया की समस्याओं के समाधान के लिए प्रतिभाशाली दिमागों को एक साथ लाता है।",
          ahvac: "पहले से ही खाता है?",
          log: "लॉग इन करें",
          About: "हमारे बारे में",
          timeline: "समयरेखा",
          pc: "शिक्षा वह शक्ति है",
          Demo: "डेमो आज़माएं!",
          tip: "दुनिया को बदल सकती है!",
          at: " जो ",
          Signin: "साइन इन करें",
          sup: "साइन अप करें",
          i1t: "भारत की आजादी",
